    ...
    $.fn.fixMe = function() {
        return this.each(function() {
            var $this = $(this),
                ...
                heightFilterBarHead = $filterBarHead.outerHeight(),
                $win = $(window);
            ...
            function scrollFixed() {
                var scrollTopWin = $(this).scrollTop(),
                    heightHeader = $('header.header').outerHeight(),
                    offsetWrapTable = $this.closest('.wrap-table').offset().top,
                    heightHeader = $('header.header').outerHeight(),
                    topHeadtable = scrollTopWin - (offsetWrapTable - heightHeader);
                if (topHeadtable >= 0) {
                    $t_fixed.show().css('top', topHeadtable + heightFilterBarHead);
                    $filterBarHead.addClass('absolute').css('top', topHeadtable);
                } else {
                    $t_fixed.hide();
                    $filterBarHead.removeClass('absolute').css('top', '');
                }
            }

            $(window).on('resize.resizeHeaderTable', resizeFixed);
            $(window).on('scroll.toogleHeaderTable', scrollFixed);
            init();
        });
    };
})(jQuery);
